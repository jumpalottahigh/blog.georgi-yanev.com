...
const MusicPage = () => (
  <div>
    ...
    <div className="disclaimer-container">
      <span className="year">~ year: 2002 - 2006 | Georgi's age: 17 - 21</span>
    ...
    <div className="m-b-1">
      <p>
        High School Shit was our first album when we were still J &amp; Blinky.
        100% own rhymes, 100% crappy Fruity Loops 4 made beats, 10% re-records
        and 0% profit. Made with love for fun.
      </p>
    </div>
