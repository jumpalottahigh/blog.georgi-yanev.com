...
const StarCraftEncyclopediaPage = () => (
  <div>
    ...
    <div className="disclaimer-container">
      <span className="year">~ year: 2000 - 2001 | Georgi's age: 15 - 16</span>
    ...
    <div className="m-b-1">
      <p>
        To say I had my fair share of StarCraft obsession doesn't even begin to
        describe it. I also wrote an encyclopedia on the topic, covering every
        unit of the game. Excuse the comic sans, and pictures created in MS
        Paint :)
      </p>
      <p>
