...
const SupportMePage = () => (
  <Layout>
    <Section>
      <h1>Support me</h1>
      <h5>If you like what I do and would like to help me do more of it...</h5>
      <Task>
        <h2>
          1.{' '}
          <a
        ...
        <p>
          ...
          appreciated! Bonus points for <strong>liking</strong> videos, watching
      ...
      <Task>
        ...
        <p>
          It doesn't cost you anything, and I will get a small commision. It all
          adds up, and I re-invest almost everything back into more FPV gear and
          drones for reviews, builds and mods which I then publish on the blog
      ...
      <Task>
        ...
        <p>
          No spam. I send out up to 1 email per month and can skip less eventful
          months.
        </p>
      </Task>
      <Task>
        ...
        <p>
          I don't put nearly as much effort into my second channel, it's mostly
          for dumping raw flight footage of various drones. But there are some
          pretty nice freestyle videos in there.
        </p>
      </Task>
      <Task>
