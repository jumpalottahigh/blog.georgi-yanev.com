...
const IndexPage = ({ data }) => (
  <Layout>
    <div>
      ...
      <p>
        <br />
        I believe that however we build apps on the web, they always end up in
        the <strong>hands of humans</strong> and it's crucial that we address{' '}
      ...
      <p style={{ marginTop: '1rem', fontSize: '0.9rem' }}>
        ...
        unedited content (fan fiction, music and programming) from the early
        2000s when I was only 15 - 17.
      </p>
      <img style={{ marginBottom: '1rem' }} src={introImage} alt="YAR cover" />
    </div>
  </Layout>
)
