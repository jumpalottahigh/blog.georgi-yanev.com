...
ogDescription: "It's finally here! RunCam's latest GoPro competitor camera - the RunCam 5. In the meantime, GoPro has discountinued the Session 5 - many FPV pilots' favorite camera, leaving people with the option to grab a refurbished one from Ebay, buy used from elsewhere or move on to use a Hero 6 with a slightly different form factor. This is where RunCam's new offering comes in."
ogImage: './runcam-5-5.jpg'
---

It's finally here! RunCam's latest GoPro competitor camera - the [RunCam 5][1]. In the meantime, GoPro has discountinued the Session 5 - many FPV pilots' favorite camera, leaving people with the option to grab a refurbished one from Ebay, buy used from elsewhere or move on to use a Hero 6 with a slightly different form factor. This is where RunCam's new offering comes in.

There are a number of comparison videos on the Internet so definitely do some more research before you purchase anything, but for many reasons I'm very much interested in the RunCam 5 camera. My excitement stems mainly from the fact that RunCam makes cameras especially dedicated for FPV pilots. Furthermore **I have been using RunCam's Split cameras for over a year now and I am very pleased with the fpv feed when flying, as well as the 1080p HD video recording**.
...
Inside we find the camera sitting in the middle of a bed of a sponge like soft material, wrapped from all sides.

![RunCam 5 inside its shipping box](runcam-5-3.jpg)

The lense has a protective plastic layer that needs to be peeled off before usage. We also notice a single button on top and an LED.
...
In addition, you get a manual and a small box with a few accesories.
...
One of the most outstanding features of the [RunCam 5][1] is its weight! **It's by far one of the (if not THE) lightest camera in its class!** It comes in at just **56 grams**. That's very, very light. In comparison the Hero 5 Session weighs 74 grams. Here are the rest of the technical specifications:
...
As far as battery capacity goes, **RunCam claim the built-in 960 mAh battery should get you more than 90 minutes of 1080p 60fps recording time, or about 60 minutes of 4k 30fps recording time**. And yes, the battery is irreplaceable, built-in battery. Which might be one of the necessary shortcuts RunCam had to take in order to drive the price of the camera that low. I personally don't mind at all that the battery is built-in.
...
The RunCam 5 has a 12MP Sony sensor with a field of view of 145 degrees. The output is in MP4 format, it supports resolutions from 1080p to 4K which we will dive in deeper in a minute.
...
This mount worked pretty good. Attached it with a couple of thicker zip ties and in addition ran around the rubberized velcro strap too.
